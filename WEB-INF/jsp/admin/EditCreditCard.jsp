...
<form:form method="post" commandName="command">
	...
	<table border="0" cellspacing="0">
		...
		<tr>			
			...
			<td class="input"><form:checkbox path="creditCard.verified"/></td>
			<td class="error"><form:errors path="creditCard.verified" /></td>
		</tr>
		<tr>			
			<td class="label">Modified</td>
			<td class="input"><form:checkbox path="creditCard.cardModified"/></td>
			<td class="error"><form:errors path="creditCard.cardModified" /></td>
		</tr>
		<tr>			
			<td class="label">Suspended</td>
			<td class="input"><form:checkbox path="creditCard.suspended"/></td>
			<td class="error"><form:errors path="creditCard.suspended" /></td>
		</tr>
