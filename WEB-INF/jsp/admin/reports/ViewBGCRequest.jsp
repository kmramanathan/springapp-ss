...
<neon:page title="View BGC Request">
<jsp:attribute name="stylesheet">admin.css</jsp:attribute>

<jsp:body>
<h2>View BGC Request</h2>
...
<table class="bgcRequest">
	...
	<tr>
		...
		<td class="value"><c:out value="${req.middleName}"/></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="label">First Name Exact Match</td>
		<td class="value"><c:out value="${req.firstNameExact}"/></td>
	</tr>	
	<tr>
		<td class="label">Last Name Exact Match</td>
		<td class="value"><c:out value="${req.lastNameExact}"/></td>
	</tr>	

	<tr>
		<td class="label">Nationwide</td>
		<td class="value"><c:out value="${req.usonesearch}"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="value"><c:out value="${req.dobYearRange}"/></td>
	</tr>
	<tr>
		<td class="label">Match Fuzzy DOB</td>
		<td class="value"><c:out value="${req.dobMatchFuzzyDates}"/></td>
	</tr>
	<tr>
		<td class="label">Match Missing DOB</td>
		<td class="value"><c:out value="${req.dobMatchFuzzyDates}"/></td>
	</tr>
	<tr>
