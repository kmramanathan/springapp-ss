...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Corporations by Address</title>
            ...
            <div id="logo">
              ...
              <table width="945" height="532" border="0">
				...
				<p class="style39">
                    ...
                    <p align="left"><img src="/springapp/images/common/nav-tab-address.jpg" alt="nav tab address" width="550" height="35" border="0" usemap="#Map" /></p>
                    <table width="636" height="54" border="1" bordercolor="#000000" bgcolor="#FEF8A5">
                      <tr>
                        <td><div align="left">
                          <table width="623">
                            <tr>
                              <td width="286"><h3 align="left">Search by Address</h3>
                            ...
                            <tr>
                              <td><label>
                                <form:input path="corporateSearchAddress" cssClass="formfield" size="40" />
                              </label></td>
                              <td><label>
                  ...
                  <td width="220"><p><img src="/springapp/images/common/image-female-businesswoman.jpg" alt="female businesswoman" width="261" height="301" /></p>
...
<map name="Map" id="Map"><area shape="rect" coords="4,10,173,34" href="corporateSearchLanding.do?searchType=company" alt="search by company" />
<area shape="rect" coords="349,10,543,34" href="corporateSearchLanding.do?searchType=officer" alt="Search by officer/agent" />
</map>
