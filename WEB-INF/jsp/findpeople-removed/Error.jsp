					...
					<div id="content">
						<div id="title"><img src="/springapp/images/common/confirm-search.gif" alt="Error" /></div>
          				<div id="formwrapper">
							...
							<a href="https://www.searchsystems.net/springapp/findpeople/searchLanding.do">Return to the start page</a>
						</div>				
					</div>
                    <!--// content ends //-->
...
<script type="text/javascript">TrustLogo("https://www.searchsystems.net/springapp/images/findpeople/Comodo-seal-100.gif", "SC", "none");</script></li>
            </ul>
            <!--// security icons end //-->
