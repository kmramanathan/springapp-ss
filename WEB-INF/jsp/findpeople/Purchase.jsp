        ...
        <!--// column one begins //--> 
          <td id="colone" align="left"><div class="wrap"><div class="innerwrap">
              ...
              <div id="formwrapper">
              	...
              	<p>Please make sure that your name and address are the same as on the mailing address on your credit card statement.  The SearchSystems.net website protects your billing information and personal information through secure communications provided by Comodo SSL Certified encryption. <span class="req"><strong>*</strong></span> Required Fields</p>
...
<form:form method="post">
	...
	<form:errors path="*" element="div" id="error" cssClass="error-box"/>
		<ul class="ccdetails">
			<c:url var="purchaseUrlIntl" value="purchaseMexicanRecordSearch.do?i18n=1"/>
			<c:if test="${!command.i18n}">
				<li>
				<strong><a href="showStaticPages.do?page=InBillMsg" target="_blank">Outside the US? Click here</a></strong>
				</li>
			</c:if>             	
...
(Area code first. No parentheses or dashes, ex: 2135550010)
                    ...
                    <li class="checkbox"><label></label><form:checkbox path="acceptAgreement" cssClass="formfield" /> I have read &amp; agree to the <a href="http://www.searchsystems.net/tos.php" target="_blank">Terms of Use</a></li>
                </ul>
               
             <center> <input type="image" src="/springapp/images/common/bt-make-your-secure-payment.gif" alt="Proceed to Payment Form" /> </center>
