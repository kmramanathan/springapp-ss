...
{
	setTimeout('document.images.delayGif.src = "/springapp/img/ajax-loader.gif', 10);
 ...
 <tr><td colspan="4">&nbsp;</td> </tr>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="950" id="maintable"><tr valign="top">
       ...
       <tr>
                                                    ...
                                                    <h1><span class="style102">Corporations Search in Progress...</span></h1>
                                                    <p>&nbsp;</p>
                                                        <p align="center"><img name="delayGif" src="/springapp/img/ajax-loader.gif" alt="searching" width="32" height="32"></p>
                                                   
                                                    <h3>Your search is processing. Please DO NOT click your Back button or refresh this page.</h3>
                    <p>Depending on the terms you input and the number of potential matches in the database, this search could take a few moments to complete. </p>
													</td>
                                                  </tr>
...
<div class="footer style19h style20h">
<img src="/springapp/images/common/Footer.png" border="0 alt="ss-footer" width="418" height="69" usemap="#footer">
</div>
<map name="footer">
  <area shape="poly" coords="242,43,280,43,327,43,330,57,270,59,242,59,243,51," alt="Privacy Policy" href="http://publicrecords.searchsystems.net/privacypolicy.php">
