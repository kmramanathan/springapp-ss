            ...
            <tr>
              ...
              <td width="204">
              	<p align="left" class="style107">
              		...
              		<c:if test="${!empty sessionScope.username}">
                		<span class="style107"><a href="newSearchBJL.do">Start a New Search</a></span>
                	</c:if>
              	</p>
              		<p align="left"><span class="style107"><a href="newResultsBJL.do?download=true">Download</a></span></p>
              		<p align="left"><span class="style107"><a href="javascript:window.print();">Print</a></span></p>
              
                <p align="left"><span class="style107"><a href="newResultsBJL.do">Back to Results</a></span>    </p>
              </td>
            </tr>
          </table>
