...
<neon:StoppageFunnel title="${title}" >
                                ...
                                <tr>
                                  ...
                                  <td width="672"><table width="635">
                                    <tr>
                                      ...
                                      <a href="newBJLSearch.do?searchType=name"><form:radiobutton path="bjlsearchByType" value="name"/></a>
                                        <span class="style126">Name</span></td>
                                      <td width="23">&nbsp;</td>
                                      <td width="495"><label>
                                        
                                        <a href="newBJLSearch.do?searchType=ssn"><form:radiobutton path="bjlsearchByType" value="ssn"/></a>
...
<input type="hidden" name="bjlNameType" value="Any" />
                                  ...
                                  <td width="485" height="117"><table width="475" border="0">
                                      <tr>
                                        ...
                                        <td width="245"><div align="left">
                                            ...
                                            <form:input path="bjllastname" size="34" maxlength="34"/>
                                        </div></td>
                                      </tr>
                                      <tr>
                            ...
                            <table width="820" border="0">
                                <tr>
                                  ...
                                  <td width="314"><input type="image" src="images/common/bt-start-search-small.png" alt="start search" width="138" height="48" /></td>
                            ...
                            <input type="hidden" name="bjllastname" value=" "> 
                                ...
                                <tr>
                                  <td width="485" height="159"><table width="475" border="0">
                                      <tr>
                                        ...
                                        <td width="245"><div align="left">
                                           <form:input path="bjlssn" size="18" maxlength="18" />
                                        </div></td>
                                      </tr>
                                      <tr>
                                        <td height="27"><div align="left"><span class="style113">*Required Field</span></div></td>
