...
<neon:NewEvictionFunnel title="Screen Business Tenants for Evictions" >
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td><h1 class="style59">Screen Business Tenants for Evictions</h1></td>
		<td><p class="style818 style71" ><strong>Search eviction records by state and get instant results for just $5.</strong></p></td>
	</tr>
</table>
            ...
            <td width="100%" >
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr valign="top">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="182" bgcolor="#FFFF99"><p class="style71" style="margin:0;padding:0 0 0 8px"><strong>Search Business Name</strong></p></td>
                        <td width="150" bgcolor="#FFFFFF">&nbsp;</td>
                        <td width="223" bgcolor="#B4DDFE" class="style71"><div align="right"><a href="/springapp/funnel/eviction-records.do"><strong>Search Individual Name</strong></a></div></td>
                      </tr>
                    </table>
                      <table width="100%" bgcolor="FFFF99" border="0" cellpadding="0" cellspacing="0">
                       
                        <tr>
                          <td><span class="style71"><label>Business Name<strong class="style72">*</strong>:</label></span></td>
                          <td>
                            
                            <form:input path="businessname" cssClass="formfield" size="20" maxlength="20" />
                            </td>
                            <td>
                          	<span class="style71">
                        ...
                        <tr >
                          <td colspan="3">
                          <div id="cityShow" style="display: none;" align="center">
