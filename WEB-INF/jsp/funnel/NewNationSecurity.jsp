...
<tr><td colspan="2">
           <p class="style1111">Search 108 National, International, and State databases for stock exchange disciplinary actions, financial exclusion lists, known terrorists, casino cheats, national and international most wanted and fugitive lists, debarred parties, investment bans, Medicaid exclusion lists, sanctioned parties, and persons involved in government fraud, federal banking law violations, money laundering, illegal imports, and substantially more.  You'll find the full list below.</p>
           </td>
           </tr>
           </table>
...
<p><strong>Office of Foreign Assets Control (OFAC) - Consolidated Sanctions List</strong></p>
Data contains a consolidated list of non-SDN OFAC sanctions. This includes Foreign Sanction Evaders (FSE), Sectoral Sanctions Identifications (SSI), Palestinian Legislative Council (NS-PLC), List of Foreign Financial Institutions Subject to Part 561, and Non-SDN Iranian Sanctions Act (NS-ISA). This consolidated list is considered separate from the OFAC's Specially Designated Nationals and Blocked Persons List (SDN List), individuals in the consolidated list may also appear on the SDN List. Date of Birth is available for less than 5% of the records from this source. 
...
<p><strong>Office of Inspector General (OIG) - List of Excluded Individuals/Entities (LEIE)</strong></p>
...
<p><strong>System for Award Management (SAM) - Excluded Parties List</strong></p>
Official U.S. Government system that consolidated the capabilities of CCR/FedReg, ORCA, and EPLS. Previously maintained by the US General Services Administration (GSA), this list contains over 200,000 parties excluded from Federal Procurement and Non-procurement Programs. Identifies those parties excluded, throughout the U.S. Government, from receiving Federal contracts or certain subcontracts and from certain types of Federal financial and non-financial assistance and benefits.
...
<p><strong>US Department of Commerce - Denied Persons, Unverified, and Entity List</strong></p> 
Data from the U.S. Department of Commerce Bureau of Industry and Security on persons whose export privileges are denied by federal written order. This data file includes the Denied Persons List, Unverified list, and Entity List.
...
<p><strong>US Department of State - Fugitives from Justice List</strong></p>
Data contains individuals wanted by the US Department of State as fugitives from justice. These individuals are wanted for serious violations of international humanitarian law. Search results may include Name, Photo, and Narrative. Date of Birth is not available from this source.
...
<p><strong>CFPB Consumer Complaint Database</strong></p>
Data contains over 750,000 consumer complaints submitted to the Consumer Financial Protection Bureau (CFPB) dating back to 2011. Search results may include Company Name, Complaint Date, Product, Issue, Company Response, and Complaint ID.
...
<p><strong>FHFA - Suspended Counterparty Program List</strong></p>
Data contains the Federal Housing Finance Agency (FHFA) Suspended Counterparty Program List, which was created to help address the risk to Fannie Mae, Freddie Mac, and the Federal Home Loan Banks related to individuals and entities with a history of fraud or other financial misconduct. The individuals and entities included in this list are currently suspended under the Program. Search results may include Name, City and State, Effective Date and Suspension End Date.
...
<p><strong>Health Resources & Services  - Health Education Assistance Loan - Defaulted Borrowers</strong></p> 
...
List published by Australian Reserve Bank in an effort to freeze the assets of known terrorists. The list includes individuals listed in the UN Consolidated list, plus unique individuals designated by Australia's Minister for Foreign Affairs. Date of Birth or Year of Birth is available for approximately 40% of the records from this source. Please note: In 2011, the Australian government regulations made the decision to remove sanction responsibilities from the Australian Reserve Bank. All sanctions will now be administered by the Australian Department of Foreign Affairs and Trade.
...
<p><strong>Canadian Public Safety - Listed Entities</strong></p>
Data contains currently listed entities from the Canadian Public Safety. The listing of an entity is a public means of identifying a group or individual as being associated with terrorism. Search results may include Name, AKA Name, Description, Listed Date, and Reviewed Date.
<p><strong>Royal Canadian Mounted Police - Most Wanted</strong></p>
Data contains individuals currently wanted by the Royal Canadian Mounted Police.
...
<p><strong>Japan Ministry of Economy, Trade, and Industry (METI) - End User List</strong></p>
The Ministry of Economy, Trade and Industry (METI) maintains the End User List. This list contains information on foreign companies/organizations for which concerns over the development, etc. of weapons of mass destruction have been established.
...
<p><strong>Alaska Medicaid - Excluded Provider List</strong></p>
Data contains individuals excluded from participation in Medicaid services by the Alaska Department of Health and Social Services. 
<p><strong>American Samoa Sex Offender Registry</strong></p>
Data contains registered offenders from the territory of American Samoa. This source contains offenders registered as of March 2016. Search results may include Name, DOB, Address, Alias, Photo, Gender, Race, Height, Weight, Hair Color, Eye Color, Scars, Tattoos, Additional Addresses, Offense, Statute Code, and Conviction Date.
<p><strong>Arizona Adult Abuse Registry</strong></p>
Data contains individuals registered as adult abuse offenders since January 2013. The Adult Abuse Registry is maintained by the Arizona Adult Protective Services. 
<p><strong>Arizona Medicaid - Excluded Providers</strong></p>
Data contains individuals and entities currently sanctioned from participation in the Arizona Medicaid program. 
<p><strong>Arkansas Department of Human Services - Excluded Provider List</strong></p>
Data contains individuals and entities excluded from participation in Medicaid services by the Arkansas Department of Human Services. This source contains excluded offenders since July 2013.
...
<p><strong>District of Columbia - Excluded Parties List</strong></p>
Data contains individuals and entities that have been suspended or debarred by the Chief Procurement Officer. These contractors have been debarred or suspended from consideration for award of contracts or subcontracts. Search results Name, Address, Principals, Actions Date, and Termination Date.
...
<p><strong>Georgia Medicaid - Exclusion List</strong></p>
Data contains individuals and entities excluded from participation in the Georgia Medicaid program. This list is maintained by the Georgia Department of Community Health and contains all active exclusions since December 2015. Data contains Name, Business Name, Provider Type, State, and Sanction Date.
...
<p><strong>Maine Medicaid - Excluded Provider List</strong></p>
Data contains providers excluded from participation in MaineCare, the Medicaid Program for the state of Maine. This list is maintained by the Department of Health and Human Services. Data contains Name, Alias Name, Provider Type, Case Status, and Sanction Start Date. Date of Birth is not available from this source.
...
<p><strong>Massachusetts Medicaid - Excluded Providers</strong></p>
Data contains individuals and entities suspended or excluded from participating in MassHealth services. Search results may include Provider Name, Provider Type, Suspension/Exclusion Reason, and Effective Date. Date of Birth is not available from this source.
<p><strong>Michigan Medicaid - Sanctioned Providers</strong></p>
Data contains individuals and entities currently sanctioned from participation in the Michigan Medicaid program. Search results may include Name, Provider Category, NPI Number, City, License Number, and Sanction Details. Date of Birth is not available from this source.
<p><strong>Minnesota Department of Human Services - Excluded Provider List</strong></p>
Data contains individuals and entities excluded by the Minnesota Department of Human Services from participation in the Minnesota Medicaid services. Search results may include Name, Exclusion Date, Address, and Provider Type. Date of Birth is not available from this source.
...
<p><strong>Missouri Board of Pharmacy - Conditional Registration List</strong></p>
Data contains conditional registrations maintained by the Missouri Board of Pharmacy. These individuals are eligible for employment as pharmacy technicians under conditions printed on his/her registration. 
<p><strong>Missouri Board of Pharmacy - HB 600 Suspensions List</strong></p>
Data contains HB 600 (tax suspensions) maintained by the Missouri Board of Pharmacy. These individuals' licenses were suspended pursuant to Section 324.010, RSMo. 
<p><strong>Missouri Board of Pharmacy - Technician Disqualification List</strong></p>
Data contains technician disqualifications maintained by the Missouri Board of Pharmacy. These individuals are not eligible for employment as pharmacy technicians. Search results may include Name, Address, Registration Number, Effective Date, and Eligible for Rehire Date. 
...
<p><strong>North Dakota Medicaid - Excluded Provider List</strong></p>
Data contains individuals and entities excluded by the North Dakota Department of Health Services from participation in the North Dakota Medicaid program. Search results may include Name, Provider Number, Medicare Provider Number, NPI Number, Provider Type, Operating Address, Exclusion Date, and Reason for Exclusion. Date of Birth is not available from this source.
<p><strong>Ohio Department of Developmental Disabilities - Abuser Registry</strong></p>
Data contains individuals currently required to register with the Ohio Department of Developmental Disabilities Abuser Registry due to a conviction related to abuse, neglect, or misappropriation.
...
<p><strong>Ohio Medicaid - Sanctioned Providers</strong></p>
Data contains individuals and entities that have been excluded from participating in and/or providing services in the Medicaid program in Ohio. This list does NOT include voluntary resignations. Data may include Name, Provider Type, Address, Medicaid Provider Number, Date of Termination/Exclusion, Reason for Termination/Exclusion and Reinstatement Date.
...
<p><strong>Tennessee Medicaid - Terminated Providers</strong></p>
Data contains individuals and entities currently terminated from participation in the TennCare Medicaid Program in Tennessee. Search results may include Name, NPI Number, Begin Date, End Date, and Reason for Termination.
...
<p><strong>Washington Medicaid - Provider Termination List</strong></p>
Data contains individuals excluded or terminated from participation in Medicaid services by the Washington Health Care Authority. Search results may include Name, Provider License Number, Termination Date, and Termination Reason. Date of Birth is not available from this source.
<p><strong>West Virginia Medicaid - Excluded Providers</strong></p>
Data contains individuals and entities currently excluded from participation in the West Virginia Medicaid program. Search results may include Name, Provider Type, Address, Exclusion Date, Reason for Exclusion, and Exclusion Type. Date of Birth is not available from this source.
<p><strong>Wisconsin Caregiver Misconduct Registry</strong></p>
Maintained by the Wisconsin Department of Health Services, the Wisconsin Caregiver Misconduct Registry contains individuals (nurse aides and other non-credentialed caregivers) found guilty of caregiver misconduct dating back to May 2014.
<p><strong>Wyoming Medicaid - Excluded Providers</strong></p> 
Data contains individuals and entities currently sanctioned from participation in the Wyoming Medicaid program. Search results may include Name, Provider Type, Address, Provider Number, and
                       </div>
                    </td>
                  </tr>
                </table>
