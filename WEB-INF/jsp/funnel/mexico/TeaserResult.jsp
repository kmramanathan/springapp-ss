            ...
            <table width="682" border="1" bordercolor="#000000" bgcolor="#FEF8A5">
              <tr>
                <td width="672" height="265" bordercolor="#FEF8A5" bgcolor="#FEF8A5"><label>
                  ...
                  <h2 align="center"><strong>RESULTS FOUND!</strong></h2>
                  <h3 align="center" class="style40">Based on your query for the search  term:</h3>
                  <h3 align="center"><strong><%=Name%></strong></h3>
                  <h3 align="center"><span class="style40">FOUND! </span><strong><%=strCnt%>  RECORDS </strong><span class="style40">in our database that contain those words/names in the Petitioner or Respondent names.</span></h3><br />
				  <table width="654" border="0" align="center">
					  <tr>
						<td align="right"><strong>Search type:</strong></td>
						<td><strong><c:out value="${searchType}"/> court records</strong></td>
					  </tr>
					  <tr>
						<td align="right"><strong>Search by:</strong></td>
						<td style="WORD-BREAK:BREAK-ALL;"><strong><c:out value="${searchBy}"/></strong></td>
					  </tr>
					  <tr>
						<td align="right"><strong>Search Price:</strong></td>
						<td><strong>$<c:out value="${searchPrice}"/></strong></td>
					  </tr>
				  </table><br />
                  <h3 align="center" class="style40">To view the records and pay for the search, please click here:</h3>
                  <p align="center" class="style13"><label></label>
                    <a href="<c:url value="/funnel/mexico/purchaseMexicanRecordSearch.do"/>"><img src="/springapp/images/common/bt-complete-search.png" alt="complete search" width="145" height="48" /></a></p>
                  <h4 align="center" class="style42">Once you view your search results, you may refine your search at no additional
charge.</h4>
