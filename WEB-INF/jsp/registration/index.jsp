...
<meta name="author" content="Search Systems">
</jsp:attribute>
<jsp:attribute name="stylesheet">searchsystems.css,registration.css</jsp:attribute>
<jsp:body>
...
<%@ include file="/WEB-INF/jsp/registration/agreement-text.html" %>
</div>
	        </td>
            </tr>
            <tr>
