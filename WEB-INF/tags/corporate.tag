  ...
  <div class="bodywrap">
    ...
    <div id="footer">
        <div class="wrap">
            ...
            <ul class="security">
                <li><a href="${bbbUrl}" target="_blank" title="Better Business Bureau"><img src="images/common/footer-logo-bb.gif" alt="Better Business Bureau" /></a></li>
                <li><a onClick="${thawteOnClick}" href="#"  title="Thawte"><img src="images/common/footer-logo-thawte.gif" alt="Thawte" /></a></li>
            </ul>
            <!--// security icons end //-->
