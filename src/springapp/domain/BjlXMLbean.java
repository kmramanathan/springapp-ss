...
public class BjlXMLbean {
	...
	ArrayList bjlName=new ArrayList();
	ArrayList bjlAddress=new ArrayList();
	ArrayList bjlFiling=new ArrayList();
	...
	public ArrayList getBjlName() {
		return bjlName;
	}
	public void setBjlName(ArrayList bjlName) {
		this.bjlName = bjlName;
	}
	public ArrayList getBjlAddress() {
		return bjlAddress;
	}
	public void setBjlAddress(ArrayList bjlAddress) {
		this.bjlAddress = bjlAddress;
	}
	public ArrayList getBjlFiling() {
		return bjlFiling;
	}
	public void setBjlFiling(ArrayList bjlFiling) {
		this.bjlFiling = bjlFiling;
	}
	...
	public bjlNameObj(String name_filing_state,String firstname,String middlename,String lastname,String name_suffix,String name_type,
			String name_type_desc,String ssn_taxid_flag,String ssn,String comment_sequence,String comment_type,
			String comment_type_desc,String fullname,String businessname,String dob)
	{
	...
	public static class bjlAddressObj
	{
		...
		String street_direction,String street_name,	String street_suffix,String apartment_num,
	...
	public static class bjlFilingObj
	{
		...
		,String court_address,String court_city,String court_zip,String court_phone,
		String sched_341_time,String judge,String lawfirm,String book,String page,String origdept,String origcase,
		String origbook,String origpage,String assoccode,String actiontype,String actiontypedesc)
		{
			...
			//Udhay Aug8 ==> New Tracers filed addedd			
