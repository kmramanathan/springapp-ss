...
public abstract class BaseCorporationSearchesPeer extends BasePeer {
	 /** Serial version */
    ...
    {
        return getMapBuilder(CorporationSearchesMapBuilder.CLASS_NAME);
    }
    ...
    public static final String INVOICED;
      /** the column name for the refernce field */
  public static final String REFERENCE;
  
    static
    {
        DATABASE_NAME = "services";
        TABLE_NAME = "corporation_searches";

              	  USER_SEARCH_ID = "corporation_searches.user_search_id";
                  SEARCH_CATEGORY_ID = "corporation_searches.search_category_id";
                  SEARCH_SUB_CATEGORY_ID = "corporation_searches.search_sub_category_id";
                  USER_ID = "corporation_searches.user_id";
                  TRANSACTION_ID = "corporation_searches.transaction_id";
                  MATCH_COUNT = "corporation_searches.match_count";
                  CREATE_DATE = "corporation_searches.create_date";
                  COMPLETED = "corporation_searches.completed";
                  SEARCH_STATUS_ID = "corporation_searches.search_status_id";
                  FIRSTNAME = "corporation_searches.firstname";
                  LASTNAME = "corporation_searches.lastname";
                  BUSINESSNAME = "corporation_searches.businessname";
                  INITIAL = "corporation_searches.initial";
                  STATE = "corporation_searches.state";
                  INVOICED = "corporation_searches.invoiced";
                  REFERENCE = "corporation_searches.reference";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(CorporationSearchesMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(CorporationSearchesMapBuilder.CLASS_NAME);
        }
    }
   ...
   // protected static final String CLASSNAME_DEFAULT =
    ...
    protected static final String CLASSNAME_DEFAULT="springapp.domain.corporation.CorporationSearches";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseCorporationSearchesPeer
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(INITIAL);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CorporationSearches row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CorporationSearches obj = (CorporationSearches) cls.newInstance();
            CorporationSearchesPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
                  ...
                  obj.setBusinessname(row.getValue(offset + 11).asString());
                  obj.setInitial(row.getValue(offset + 12).asString());
                  obj.setState(row.getValue(offset + 13).asString());
                  obj.setInvoiced(row.getValue(offset + 14).asBoolean());
                  obj.setReference(row.getValue(offset + 15).asString());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CorporationSearches> results = new ArrayList<CorporationSearches>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(CorporationSearchesPeer.row2Object(row, 1,
                CorporationSearchesPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> doSelect(CorporationSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CorporationSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CorporationSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CorporationSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CorporationSearches obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CorporationSearches obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CorporationSearches obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CorporationSearches obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            ...
            criteria.add(USER_SEARCH_ID, obj.getUserSearchId());
              ...
              criteria.add(INITIAL, obj.getInitial());
    ...
    public static Criteria buildSelectCriteria( CorporationSearches obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static CorporationSearches retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CorporationSearches retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CorporationSearches retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CorporationSearches retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CorporationSearches retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CorporationSearches> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (CorporationSearches)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CorporationSearches> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CorporationSearches> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CorporationSearches> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CorporationSearches>();
        }
        else
        {
            Criteria criteria = new Criteria();
