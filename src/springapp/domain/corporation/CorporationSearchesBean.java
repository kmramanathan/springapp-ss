...
public class CorporationSearchesBean implements Serializable{
	 /**
	 * 
	 */
     ...
     */
    protected List<BaseCorporationResultsBean> collCorporationResultsBeans;

    /**
     * Returns the collection of BjlResultsBeans
     */
    public List<BaseCorporationResultsBean> getCorporationResultsBeans()
    {
        return collCorporationResultsBeans;
    }

    /**
     * Sets the collection of BjlResultsBeans to the specified value
     */
    public void setCorporationResultsBeans(List<BaseCorporationResultsBean> list)
    {
        if (list == null)
        {
        	collCorporationResultsBeans = null;
        }
        else
        {
        	collCorporationResultsBeans = new ArrayList<BaseCorporationResultsBean>(list);
        }
    }
