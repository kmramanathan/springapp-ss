...
public abstract class BaseEvictionSearches extends BaseObject{
	 /** Serial version */
    private static final long serialVersionUID = 1230102311301L;

    /** The Peer class */
    private static final EvictionSearchesPeer peer =
        new EvictionSearchesPeer();
    ...
    public void setUserSearchId(long v) throws TorqueException
    {
        ...
        if (collBjlResultss != null)
        {
            ...
            {
                ((EvictionResults) collBjlResultss.get(i))
                        .setUserSearchId(v);
            }
        }
                                }
     ...
     */
    protected List<EvictionResults> collBjlResultss;
    ...
    protected void initBjlResultss()
    {
        if (collBjlResultss == null)
        {
            collBjlResultss = new ArrayList<EvictionResults>();
        }
    }
     ...
     */
    public void addBjlResults(EvictionResults l) throws TorqueException
    {
        getBjlResultss().add(l);
        l.setEvictionSearches((EvictionSearches) this);
    }
     ...
     * @return the collection of associated objects
           * @throws TorqueException
           */
    public List<EvictionResults> getBjlResultss()
              throws TorqueException
          {
                      if (collBjlResultss == null)
        {
     ...
     * @throws TorqueException
     */
    public List<EvictionResults> getBjlResultss(Criteria criteria) throws TorqueException
    {
              if (collBjlResultss == null)
        {
            if (isNew())
            ...
            {
                        criteria.add(EvictionResultsPeer.USER_SEARCH_ID, getUserSearchId() );
                        collBjlResultss = EvictionResultsPeer.doSelect(criteria);
            }
        }
        else
        {
     ...
     */
    public List<EvictionResults> getBjlResultss(Connection con) throws TorqueException
    {
              if (collBjlResultss == null)
        {
     ...
     * that is taken as input
     */
    public List<EvictionResults> getBjlResultss(Criteria criteria, Connection con)
            throws TorqueException
    {
              if (collBjlResultss == null)
        {
            ...
            {
                         criteria.add(EvictionResultsPeer.USER_SEARCH_ID, getUserSearchId());
                         collBjlResultss = EvictionResultsPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     */
    protected List<EvictionResults> getBjlResultssJoinBjlSearches(Criteria criteria)
        throws TorqueException
    {
                    if (collBjlResultss == null)
        {
            ...
            {
                              criteria.add(EvictionResultsPeer.USER_SEARCH_ID, getUserSearchId());
                              collBjlResultss = EvictionResultsPeer.doSelectJoinBjlSearches(criteria);
            }
        }
        else
        {
                                    ...
                                    if (!lastBjlResultssCriteria.equals(criteria))
            {
               // collBjlResultss = BjlResultsPeer.doSelectJoinBjlSearches(criteria);
                  collBjlResultss=BaseEvictionResultsPeer.doSelectJoinBjlSearches(criteria);
            }
        }
        lastBjlResultssCriteria = criteria;
    ...
    {
          if (name.equals(EvictionSearchesPeer.USER_SEARCH_ID))
        {
                return new Long(getUserSearchId());
            }
          if (name.equals(EvictionSearchesPeer.SEARCH_CATEGORY_ID))
        {
                return new Short(getSearchCategoryId());
            }
          if (name.equals(EvictionSearchesPeer.SEARCH_SUB_CATEGORY_ID))
        {
                return new Short(getSearchSubCategoryId());
            }
          if (name.equals(EvictionSearchesPeer.USER_ID))
        {
                return new Integer(getUserId());
            }
          if (name.equals(EvictionSearchesPeer.TRANSACTION_ID))
        {
                return new Integer(getTransactionId());
            }
          if (name.equals(EvictionSearchesPeer.MATCH_COUNT))
        {
                return new Short(getMatchCount());
            }
          if (name.equals(EvictionSearchesPeer.CREATE_DATE))
        {
                return getCreateDate();
            }
          if (name.equals(EvictionSearchesPeer.COMPLETED))
        {
                return Boolean.valueOf(getCompleted());
            }
          if (name.equals(EvictionSearchesPeer.SEARCH_STATUS_ID))
        {
                return new Short(getSearchStatusId());
            }
          if (name.equals(EvictionSearchesPeer.FIRSTNAME))
        {
                return getFirstname();
            }
          if (name.equals(EvictionSearchesPeer.LASTNAME))
        {
                return getLastname();
            }
          if (name.equals(EvictionSearchesPeer.BUSINESSNAME))
        {
                return getBusinessname();
            }
          if (name.equals(EvictionSearchesPeer.CITY))
        {
                return getCity();
            }
          if (name.equals(EvictionSearchesPeer.STATE))
        {
                return getState();
            }
          if (name.equals(EvictionSearchesPeer.INVOICED))
          {
                  return Boolean.valueOf(getInvoiced());
              }
         
          if (name.equals(EvictionSearchesPeer.REFERENCE))
        {
                return getReference();
            }
          return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (EvictionSearchesPeer.USER_SEARCH_ID.equals(name))
        {
            return setByName("UserSearchId", value);
        }
        if (EvictionSearchesPeer.SEARCH_CATEGORY_ID.equals(name))
        {
            return setByName("SearchCategoryId", value);
        }
        if (EvictionSearchesPeer.SEARCH_SUB_CATEGORY_ID.equals(name))
        {
            return setByName("SearchSubCategoryId", value);
        }
        if (EvictionSearchesPeer.USER_ID.equals(name))
        {
            return setByName("UserId", value);
        }
        if (EvictionSearchesPeer.TRANSACTION_ID.equals(name))
        {
            return setByName("TransactionId", value);
        }
        if (EvictionSearchesPeer.MATCH_COUNT.equals(name))
        {
            return setByName("MatchCount", value);
        }
        if (EvictionSearchesPeer.CREATE_DATE.equals(name))
        {
            return setByName("CreateDate", value);
        }
        if (EvictionSearchesPeer.COMPLETED.equals(name))
        {
            return setByName("Completed", value);
        }
        if (EvictionSearchesPeer.SEARCH_STATUS_ID.equals(name))
        {
            return setByName("SearchStatusId", value);
        }
        if (EvictionSearchesPeer.FIRSTNAME.equals(name))
        {
            return setByName("firstname", value);
        }
        if (EvictionSearchesPeer.LASTNAME.equals(name))
        {
            return setByName("lastname", value);
        }
        if (EvictionSearchesPeer.BUSINESSNAME.equals(name))
        {
            return setByName("businessname", value);
        }
        if (EvictionSearchesPeer.CITY.equals(name))
        {
            return setByName("city", value);
        }
        if (EvictionSearchesPeer.STATE.equals(name))
        {
            return setByName("state", value);
        }
        if (EvictionSearchesPeer.INVOICED.equals(name))
        {
            return setByName("Invoiced", value);
        }
        
        if (EvictionSearchesPeer.REFERENCE.equals(name))
        {
    ...
    {
          save(EvictionSearchesPeer.DATABASE_NAME);
      }
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                   // EvictionSearchesPeer.doInsert((BjlSearches) this, con);
                	EvictionSearchesPeer.doInsert((EvictionSearches) this, con);
                	
                    setNew(false);
                }
                else
                {
                  //  EvictionSearchesPeer.doUpdate((BjlSearches) this, con);
                	EvictionSearchesPeer.doUpdate((EvictionSearches)this, con);
                }
                }
                                    ...
                                    if (collBjlResultss != null)
            {
                for (int i = 0; i < collBjlResultss.size(); i++)
                {
                    ((EvictionResults) collBjlResultss.get(i)).save(con);
                }
            }
                                  alreadyInSave = false;
        }
     ...
     * related objects to isNew=true.
       */
      public EvictionSearches copy() throws TorqueException
    {
            return copy(true);
        }
     ...
     */
    public EvictionSearches copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new EvictionSearches(), deepcopy);
    }
     ...
     */
    protected EvictionSearches copyInto(EvictionSearches copyObj) throws TorqueException
    {
     ...
     * and treated as new objects.
       ...
       */
      protected EvictionSearches copyInto(EvictionSearches copyObj, boolean deepcopy) throws TorqueException
      {
        ...
        List<EvictionResults> vBjlResultss = getBjlResultss();
                            if (vBjlResultss != null)
        {
            for (int i = 0; i < vBjlResultss.size(); i++)
            {
                EvictionResults obj =  vBjlResultss.get(i);
     ...
     */
    public EvictionSearchesPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return EvictionSearchesPeer.getTableMap();
    }
     ...
     */
    public EvictionSearchesBean getBean()
    {
        return getBean(new IdentityMap());
    }

    /**
     * Creates a EvictionSearchesBean with the contents of this object
     * intended for internal use only
     * @param createdBeans a IdentityMap which maps objects
     *        to already created beans
     * @return a EvictionSearchesBean with the contents of this object
     */
    public EvictionSearchesBean getBean(IdentityMap createdBeans)
    {
        EvictionSearchesBean result = (EvictionSearchesBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new EvictionSearchesBean();
        createdBeans.put(this, result);
          ...
          result.setReference(getReference());
                  ...
                  if (collBjlResultss != null)
        {
            List<BaseEvictionResultsBean> relatedBeans = new ArrayList<BaseEvictionResultsBean>(collBjlResultss.size());
            for (Iterator<EvictionResults> collBjlResultssIt = collBjlResultss.iterator(); collBjlResultssIt.hasNext(); )
            {
                EvictionResults related = (EvictionResults) collBjlResultssIt.next();
                BaseEvictionResultsBean relatedBean = related.getBean(createdBeans);
                relatedBeans.add(relatedBean);
            }
            result.setEvictionResultsBeans(relatedBeans);
        }
     ...
     * of a EvictionSearchesBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the EvictionSearchesBean which contents are used to create
     *        the resulting class
     * @return an instance of BjlSearches with the contents of bean
     */
    public static EvictionSearches createBjlSearches(EvictionSearchesBean bean)
        throws TorqueException
    {
    ...
    /**
     * Creates an instance of EvictionSearches with the contents
     * of a EvictionSearchesBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed.
     *
     ...
     * @return an instance of EvictionSearches with the contents of bean
     */

    public static EvictionSearches createBjlSearches(EvictionSearchesBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
    	EvictionSearches result = (EvictionSearches) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new EvictionSearches();
        ...
        {
            List<BaseEvictionResultsBean> relatedBeans = bean.getEvictionResultsBeans();
            if (relatedBeans != null)
            {
                for (Iterator<BaseEvictionResultsBean> relatedBeansIt = relatedBeans.iterator(); relatedBeansIt.hasNext(); )
                {
                	BaseEvictionResultsBean relatedBean =  relatedBeansIt.next();
                    EvictionResults related = EvictionResults.createBjlResults(relatedBean, createdObjects);
    ...
    /**
     * Method called to associate a EvictionResults object to this object.
     * through the EvictionResults foreign key attribute
     *
     * @param toAdd EvictionResults
     */
    protected void addBjlResultsFromBean(EvictionResults toAdd)
    {
        initBjlResultss();
