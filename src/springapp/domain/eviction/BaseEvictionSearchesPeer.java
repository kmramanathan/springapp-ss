...
import springapp.domain.eviction.map.EvictionSearchesMapBuilder;
...
public abstract class BaseEvictionSearchesPeer extends BasePeer {
	 /** Serial version */
    ...
    {
        return getMapBuilder(EvictionSearchesMapBuilder.CLASS_NAME);
    }
  ...
  public static final String REFERENCE;
    ...
    static
    {
        ...
        TABLE_NAME = "eviction_searches";

              	  USER_SEARCH_ID = "eviction_searches.user_search_id";
                  SEARCH_CATEGORY_ID = "eviction_searches.search_category_id";
                  SEARCH_SUB_CATEGORY_ID = "eviction_searches.search_sub_category_id";
                  USER_ID = "eviction_searches.user_id";
                  TRANSACTION_ID = "eviction_searches.transaction_id";
                  MATCH_COUNT = "eviction_searches.match_count";
                  CREATE_DATE = "eviction_searches.create_date";
                  COMPLETED = "eviction_searches.completed";
                  SEARCH_STATUS_ID = "eviction_searches.search_status_id";
                  FIRSTNAME = "eviction_searches.firstname";
                  LASTNAME = "eviction_searches.lastname";
                  BUSINESSNAME = "eviction_searches.businessname";
                  CITY = "eviction_searches.city";
                  STATE = "eviction_searches.state";
                  INVOICED = "eviction_searches.invoiced";
                  REFERENCE = "eviction_searches.reference";
              if (Torque.isInit())
        {
            try
            {
                getMapBuilder(EvictionSearchesMapBuilder.CLASS_NAME);
            }
            catch (Exception e)
            {
        ...
        {
            Torque.registerMapBuilder(EvictionSearchesMapBuilder.CLASS_NAME);
        }
    }
   ...
   // protected static final String CLASSNAME_DEFAULT =
    ...
    protected static final String CLASSNAME_DEFAULT="springapp.domain.eviction.EvictionSearches";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseEvictionSearchesPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static EvictionSearches row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            EvictionSearches obj = (EvictionSearches) cls.newInstance();
            EvictionSearchesPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<EvictionSearches> results = new ArrayList<EvictionSearches>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
              results.add(EvictionSearchesPeer.row2Object(row, 1,
                EvictionSearchesPeer.getOMClass()));
          }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> doSelect(EvictionSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EvictionSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EvictionSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EvictionSearches obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EvictionSearches obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EvictionSearches obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EvictionSearches obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( EvictionSearches obj )
    {
    ...
    public static Criteria buildSelectCriteria( EvictionSearches obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
        {
     ...
     */
    public static EvictionSearches retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EvictionSearches retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EvictionSearches retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        EvictionSearches retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EvictionSearches retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<EvictionSearches> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (EvictionSearches)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<EvictionSearches> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<EvictionSearches> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<EvictionSearches> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<EvictionSearches>();
        }
        else
        {
            Criteria criteria = new Criteria();
