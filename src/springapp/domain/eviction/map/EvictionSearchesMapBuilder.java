...
public class EvictionSearchesMapBuilder implements MapBuilder{
	/**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "springapp.domain.eviction.map.EvictionSearchesMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("eviction_searches");
        TableMap tMap = dbMap.getTable("eviction_searches");
        tMap.setJavaName("EvictionSearches");
        tMap.setOMClass( springapp.domain.eviction.EvictionSearches.class );
        tMap.setPeerClass( springapp.domain.eviction.EvictionSearchesPeer.class );
