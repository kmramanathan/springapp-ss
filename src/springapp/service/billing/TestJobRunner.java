...
public class TestJobRunner extends QuartzJobBean {
	private static final String APPLICATION_CONTEXT_KEY = "applicationContext";
	private static final String JOB_BEAN_NAME_KEY = "testJob";
	...
	protected final void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		if (hostName.equals("app1")) {
			TestJob testJob = (TestJob) appContext.getBean(JOB_BEAN_NAME_KEY);
			testJob.execute(jobExecutionContext);					
		}
	}
}